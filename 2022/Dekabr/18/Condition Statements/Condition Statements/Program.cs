    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /*
             ...
             if(sert){
                if serti odense bu skoplar arasindaki kodlar icra edilecek
             }else{
                if serti odenmese bu skoplar arasindaki kodlar icra edilecek
             }
             */
            ...
            //if (result) //esas bool tipinde bir deyer olmalidir
            //{
            //    Console.WriteLine("Salam");
            //    Console.WriteLine("name deyeri Orxan'dir.");
            ...
            /*
            İstifadəçidən bir dəyər alın. Əgər dəyər rəqəm deyilsə, ekrana "Xahis olunur bir reqem daxil edin" yazısı çıxsın.
            ...
            //    Console.WriteLine("Duzgun araliqda bal daxil etmemisiniz.");
            ...
            /*
             Kiçik bir calc app hazırlayın. İlk öncə istifadəçiyə edə biləcəyi əməliyyatları nömrələrlə göstərin.
             ...
             Sadəcə bir dənə bölmə əməliyyatında əgər b-nin dəyəri 0 olarsa, ekrana "Dəyər 0-a bölünə bilməz!" yazdırın
             */
            ...
            switch (langOrFramework)
            {
                ...
                default: //eger hec bir case'e girmese bura girecek
            ...
            switch (month)
            {
                case 1:
                    ...
                    break;
                //Iki defe eyni case'i yazmaq olmaz.
                //case 1:
                //    Console.WriteLine("Yanvar");
                //    break;
                case feb:
